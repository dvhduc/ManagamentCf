...
public class SpQuantityDrinktypeSoldByPeriod extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1620253579;

    /**
     * The parameter <code>db_milktea.sp_quantity_drinktype_sold_by_period.fromDate</code>.
     */
    ...
    /**
     * The parameter <code>db_milktea.sp_quantity_drinktype_sold_by_period.toDate</code>.
     */
     ...
     */
    public SpQuantityDrinktypeSoldByPeriod() {
        super("sp_quantity_drinktype_sold_by_period", DbMilktea.DB_MILKTEA);
