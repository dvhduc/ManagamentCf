...
public class SpGrossRevenueByDrink extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 948147096;

    /**
     * The parameter <code>db_milktea.sp_gross_revenue_by_drink.fromDate</code>.
     */
    ...
    /**
     * The parameter <code>db_milktea.sp_gross_revenue_by_drink.toDate</code>.
     */
     ...
     */
    public SpGrossRevenueByDrink() {
        super("sp_gross_revenue_by_drink", DbMilktea.DB_MILKTEA);
