...
public class FtChargedGrandtotal extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -344107158;

    /**
     * The parameter <code>db_milktea.ft_Charged_GrandTotal.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>db_milktea.ft_Charged_GrandTotal.Bill_ID</code>.
     */
     ...
     */
    public FtChargedGrandtotal() {
        super("ft_Charged_GrandTotal", DbMilktea.DB_MILKTEA, org.jooq.impl.SQLDataType.FLOAT);
