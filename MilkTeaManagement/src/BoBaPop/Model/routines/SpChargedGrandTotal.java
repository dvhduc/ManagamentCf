...
public class SpChargedGrandTotal extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -958217058;

    /**
     * The parameter <code>db_milktea.sp_charged_grand_total.Bill_ID</code>.
     */
     ...
     */
    public SpChargedGrandTotal() {
        super("sp_charged_grand_total", DbMilktea.DB_MILKTEA);
